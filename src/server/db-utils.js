...
*/
export const open = ( dbString, user, pass ) =>
{
...
*  @return {array} array of objects, objects have column labels as keys
*/
export const getRows = ( handler, table, columns, cond, limit ) =>
{
...
*  @return {int} nr. of rows affected?
*/
export const insertRow = ( handler, table, values ) =>
{
...
*  @return {int} nr. of rows affected?
*/
export const updateRow = ( handler, table, values, cond ) =>
{
...
*  @return {int} nr. of rows affected?
*/
export const deleteRow = ( handler, table, cond ) =>
{
